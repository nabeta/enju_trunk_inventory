...
class InventoryCheckDataImportResultsController < ApplicationController
  ...
  def index
    @inventory_check_data_import_file_id = params[:inventory_check_data_import_file_id]
    @inventory_check_data_import_file = InventoryCheckDataImportFile.find(@inventory_check_data_import_file_id)
    @inventory_check_data_import_results = InventoryCheckDataImportResult.where(:inventory_check_data_import_file_id => @inventory_check_data_import_file_id)
    @results_num = @inventory_check_data_import_results.length
